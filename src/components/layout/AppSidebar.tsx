...
import { Users, Building2, BarChart3, Settings, LayoutDashboard, ClipboardList, Crosshair, Trophy } from "lucide-react";
...
// Main menu items
const allNavItems = [
  { title: "Dashboard", url: "/dashboard", icon: LayoutDashboard, roles: ['kam', 'supervisor', 'management', 'super_admin'] },
  { title: "Targets", url: "/targets", icon: Crosshair, roles: ['supervisor', 'management', 'super_admin'] },
  { title: "KAM Performance", url: "/kam-performance", icon: Trophy, roles: ['supervisor', 'management', 'super_admin'] },
  { title: "Activities", url: "/activities", icon: ClipboardList, roles: ['kam', 'supervisor', 'management', 'super_admin'] },
  { title: "Clients", url: "/clients", icon: Building2, roles: ['kam', 'supervisor', 'management', 'super_admin'] },
];
