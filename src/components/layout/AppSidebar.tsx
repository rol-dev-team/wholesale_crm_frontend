import { Users, Building2, BarChart3, Settings, HelpCircle, LayoutDashboard, ClipboardList, Inbox, Crosshair, MessagesSquareIcon, Trophy } from "lucide-react";
...
export function AppSidebar() {
    ...
    <Sidebar className="border-r border-sidebar-border">
      <SidebarHeader className="p-4 border-b border-sidebar-border">
        <div className="flex items-center gap-3">
          <div className="w-40 h-14 rounded-lg bg-transparent flex items-center justify-center overflow-hidden">
  <img 
    src="race2.png" 
    alt="CRM Logo" 
  ...
  />
          ...
          <div className="hidden sm:block">
            <h1 className="font-semibold text-sidebar-foreground">CRM</h1>
            <p className="text-xs text-sidebar-muted">Lite Version</p>
          </div>
        </div>
      </SidebarHeader>
