...
//         <Card><CardContent className="p-4"><p>Total Clients</p><p className="text-2xl font-bold">{counts.clients}</p></CardContent></Card>
//         <Card><CardContent className="p-4"><p>Total Branch</p><p className="text-2xl font-bold">{counts.divisions}</p></CardContent></Card>
//         <Card><CardContent className="p-4"><p>Total KAM</p><p className="text-2xl font-bold">{counts.kams}</p></CardContent></Card>
//       </div>
